...
RSpec.describe Pins::SmallPinComponent, type: :component do
  ...
  context 'pin attributes' do
    ...
    it 'user#image class' do
      expect(page).to have_css '.small-pin .image'
    end

    it 'user#username' do
      expect(page).to have_css '.small-pin .body small .small-username', text: pin.user.username
    end
    ...
    it 'location icon' do
      expect(page).to have_css '.small-pin .body .icon_pin_alt'
    end

    it 'location information' do
      expect(page).to have_css '.small-pin .body small.address', text: pin.city_country
    end

    it 'add to board button' do
      expect(page).to have_css '.small-pin .body a.add_to_board_btn'
    end
  end
  ...
  context 'data sort url' do
    ...
    context 'with current_user' do
      ...
      it 'data sort url' do
        ...
        expect(page).to have_css ".small-pin[data-sort-url='#{move_pin_path}']"
      end
    end
    ...
    context 'without current_user' do
      ...
      it 'data sort url' do
        expect(page).to have_css '.small-pin[data-sort-url=""]'
      end
    end
